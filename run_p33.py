#!/usr/bin/env python3
"""P33: Асимметричный TSL для LONG и SHORT.

LONG: TSL_FROM_ENTRY_ATR_LONG = 2.0 — wider TSL, рынку нужно пространство
SHORT: TSL_FROM_ENTRY_ATR_SHORT = 1.5 — tight TSL, падения быстрые

Всё остальное — P24 параметры.
"""
import sys, os, time
...
# P33: асимметричный TSL
bt_mod.TSL_FROM_ENTRY_ATR_LONG = 2.0
...
# ── Run P33 ──
print(f"\n{'='*90}")
print(f"  P33: Асимметричный TSL — LONG={bt_mod.TSL_FROM_ENTRY_ATR_LONG}, SHORT={bt_mod.TSL_FROM_ENTRY_ATR_SHORT}")
print(f"  Всё остальное — P24 параметры")
print(f"{'='*90}")
