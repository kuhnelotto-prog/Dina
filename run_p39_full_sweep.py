#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""P39 Full Sweep: SL=2.0, 2.5, 3.0, 5.0, 5.5, 6.0, 6.5, 7.0."""
import sys, os, time
...
SWEEP_VALUES = [2.0, 2.5, 3.0, 5.0, 5.5, 6.0, 6.5, 7.0]
print("Fetching data...")
data_cache = {}
...
# COMPLETE TABLE with all known values
print(f"\n{'='*90}")
...
for sl, bp, bsl, bep, besl, cp, csl in baselines:
    grand = bp + bep + cp
    print(f"  {sl:>3.1f} | {bp:>+9.2f} {bsl:>4.1f}% | {bep:>+9.2f} {besl:>4.1f}% | {cp:>+8.2f} {csl:>4.1f}% | {grand:>+8.2f}")
