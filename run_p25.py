#!/usr/bin/env python3
"""P25: LONG_THRESHOLD_BULL=0.45 (was 0.40), LONG_BEAR=0.45, SHORT_BULL=0.45"""
import sys, os, time
...
print(f"P25: LONG_BULL=0.45 (was 0.40), LONG_BEAR=0.45, SHORT_BULL=0.45")
print(f"Baseline P24 (0.40): BULL +$173 | BEAR +$20 | CURRENT +$818 | TOTAL +$1012\n")
