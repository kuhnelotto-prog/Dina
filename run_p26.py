#!/usr/bin/env python3
"""P26: LEVERAGE=15, DEPOSIT=$100, RISK=2%, P24 thresholds"""
import sys, os, time
...
backtester.LEVERAGE = 15              # 15x leverage (reference, not used in calc)
...
print(f"P26: LEVERAGE=15, DEPOSIT=$100, RISK=2%")
print(f"P24 baseline (LEV=10, DEP=$1000, RISK=2%): BULL +$173 | BEAR +$20 | CURRENT +$818 | TOTAL +$1012")
print(f"P26 uses same thresholds as P24 but $100 deposit\n")
