#!/usr/bin/env python3
"""P17: TSL_AFTER_TP2_ATR=2.0 (was 1.5), rest = P14-V1, Binance data"""
import sys, os, time
...
# P17: TSL_AFTER_TP2_ATR = 2.0 (was 1.5)
...
print(f"P17: TSL_AFTER_TP2_ATR=2.0 (was 1.5) | {DAYS} days, 4H, {len(SYMBOLS)} coins, $1000, risk=2%")
print(f"Period: {START.date()} -> {END.date()}")
print(f"Baseline P14-V1-BINANCE: Trades 200 | WR 67.0% | PnL +$336.76 (+33.68%) | PF 1.38\n")
...
print(f"\n{'='*100}")
print(f"  P17: TSL_AFTER_TP2_ATR=2.0, MIN_PNL_TIMEOUT=72h, $1000, risk=2%")
print(f"{'='*100}")
