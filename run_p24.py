#!/usr/bin/env python3
"""P24: LONG_THRESHOLD_BULL=0.40, LONG_BEAR=0.45, SHORT_BULL=0.45"""
import sys, os, time
...
print(f"P24: LONG_BULL=0.40 (was 0.35 P23), LONG_BEAR=0.45, SHORT_BULL=0.45")
print(f"Baseline P21 (0.30): BULL PnL -$210.29 | PF 0.85")
print(f"Baseline P23 (0.35): BULL PnL -$143.78 | PF 0.89\n")
