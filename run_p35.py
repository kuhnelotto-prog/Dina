#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""P35: SL_ATR_MULT_LONG = 3.2 (vs P34 = 3.5), rest same."""
import sys, os, time
...
print(f"\n{'='*90}")
print(f"  P35: LONG=SL3.2+TP1/TP2+TSL | SHORT=SL1.5+TRAILING_STAGES(unchanged)")
print(f"{'='*90}")
