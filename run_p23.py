#!/usr/bin/env python3
"""P23: Tighter thresholds — LONG_BULL=0.35, LONG_BEAR=0.45, SHORT_BULL=0.45"""
import sys, os, time
...
print(f"P23: LONG_BULL=0.35 (was 0.30), LONG_BEAR=0.45 (was 0.40), SHORT_BULL=0.45")
print(f"Baseline P21 BULL: Trades 240 | WR 60.0% | PnL -$210.29 | PF 0.85")
print(f"Baseline P21 BULL: LONG 199 trades PF=0.78 | SHORT 41 trades PF=1.38\n")
...
for period_name, start_dt, end_dt in PERIODS:
    ...
    # LONG vs SHORT breakdown for BULL period only
    if "BULL" in period_name:
        ...
        for label, trades_list in [("LONG", long_trades), ("SHORT", short_trades)]:
            ...
            tsl_count = treasons.get('TSL', 0)
            sl_count = treasons.get('SL', 0)
