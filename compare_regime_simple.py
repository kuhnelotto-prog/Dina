...
# ============================================================================
# Вспомогательные функции (копия из symbol_backtest.py)
# ============================================================================
...
# ============================================================================
# Модифицированный Backtester с изменяемым порогом SHORT
# ============================================================================
class DynamicThresholdBacktester(Backtester):
...
def compare_symbol(symbol):
    ...
    bt_old = DynamicThresholdBacktester(use_dynamic_threshold=False)
    ...
    bt_new = DynamicThresholdBacktester(use_dynamic_threshold=True)
